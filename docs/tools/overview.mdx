...
Use the [`eve/experimental/typesafe` decision tool](./guides/typesafe#give-an-agent-the-decision-tool)
to let an agent batch typed judgments over shared evidence.
